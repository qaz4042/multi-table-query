package com.bebetter.mtq.service.multiwrapper.executor;
...
import com.bebetter.mtq.service.multiwrapper.wrapper.inner.IMultiWrapperSubAndRelationTreeNode;
...
//            MultiUtil.assertNoNull(classInfos, "找不到{0}对应的类", currTableDTOClass);
    ...
    private static <MAIN_OR_SUB> void setCurrEntityInToParent(IMultiWrapperSubAndRelationTreeNode currNode, MAIN_OR_SUB parentEntity, Class<?> currTableClass, String currRelationCode, MAIN_OR_SUB currEntity) {
        ...
        if (List.class.isAssignableFrom(returnType)) {
            if (!MultiConstant.ClassRelationOneOrManyEnum.MANY.equals(currNode.getClassNameThisOneOrMany())) {
            ...
            if (MultiConfig.multiProperties.getCheckRelationOneOrMany() && !MultiConstant.ClassRelationOneOrManyEnum.ONE.equals(currNode.getClassNameThisOneOrMany())) {
